...
export function Header({
  ...
  return (
    <header className="border-b border-[var(--border)] bg-[var(--surface)] sticky top-0 z-10">
      <div className="mx-auto max-w-6xl px-6 py-3 flex flex-wrap items-center justify-between gap-y-2 gap-x-4">
        ...
        <nav className="flex flex-wrap items-center gap-x-0.5 gap-y-1 min-w-0 flex-1 justify-center">
          {NAV.map((item) => {
