...
import { requireUser, isOwner, isSalesRep } from "@/lib/authorize";
...
export default async function SettingsPage() {
  ...
  const showSales = owner || isSalesRep(user);
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-5">
        ...
        <NotificationPreferencesForm initial={myPrefs ?? DEFAULT_PREFS} showSales={showSales} />
      </Card>
